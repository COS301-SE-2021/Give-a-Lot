...
export default function OrganisationRecommended() 
{
    return(
        <div className ="sector_organisation">
        <img src=""/>
            <div className="sector_organisation_meta">
                <p className="sector_organisation_title">The givers of hope - <span className="recommended_organisations_organisation_sector">children</span> </p>
