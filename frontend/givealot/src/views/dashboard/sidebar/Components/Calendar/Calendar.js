...
export default class DemoApp extends React.Component {
    ...
    constructor() {
        ...
        this.dataManager = new DataManager({
            url: 'http://localhost:8080/event/get/calender/coolmail@gmail.com',
...
//             if (added) {
//                 console.log("adding")
//                 const startingAddedId = data.length > 0 ? data[data.length - 1].eventId + 1 : 0;
//                 data = [...data, { eventId: startingAddedId, ...added }];
//                 console.log(data)
